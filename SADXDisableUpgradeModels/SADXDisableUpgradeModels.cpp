...
extern "C"
{
	__declspec(dllexport) void Init(const char *path, const HelperFunctions &helperFunctions)
	{
		...
		WriteData((void*)0x47B460, 0x90u, 5); // Knuckles' upgrades
		WriteJump((void*)0x48B502, (void*)0x48B52B); // Amy's Long Hammer
		WriteData((void*)0x48B542, 0x90u, 5); // Amy's Warrior Feather
		...
		WriteData((void*)0x4913CA, 0x90u, 3); // extra instruction
	}
